...
function ItemCatalogoRow({ item }: { item: Item }) {
  ...
  function salvar() {
    if (!nome.trim()) return;
    startTransition(() => updateItemCatalogo(item.id, nome, precoBase, unidade));
  }
    ...
    <>
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="card relative z-10 max-h-[85vh] w-full max-w-xl gap-0 overflow-y-auto p-6">
            ...
            <p className="mb-4 text-xs text-muted">
              Defina quanto você cobra por cada item. Os orçamentos usam esses valores como ponto de partida.
            </p>
            ...
            <div className="mt-4 border-t border-border pt-4">
              {novoAberto ? (
                ...
                >
                  ...
                  <input name="unidade" placeholder="Unidade" className="input w-24 !py-1.5 text-xs" />
